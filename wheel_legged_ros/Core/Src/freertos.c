...
void msg_task(void const * argument);
void odom_task(void const * argument);
...
void MX_FREERTOS_Init(void) {
  ...
  /* definition and creation of MSG_TASK */
  osThreadDef(MSG_TASK, msg_task, osPriorityIdle, 0, 128);
  MSG_TASKHandle = osThreadCreate(osThread(MSG_TASK), NULL);

  /* definition and creation of ODOM_TASK */
  osThreadDef(ODOM_TASK, odom_task, osPriorityIdle, 0, 128);
...
/* USER CODE BEGIN Header_msg_task */
/**
* @brief Function implementing the MSG_TASK thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_msg_task */
void msg_task(void const * argument)
{
  /* USER CODE BEGIN msg_task */
  /* Infinite loop */
  for(;;)
  {
		odom_msg_task();
  }
  /* USER CODE END msg_task */
}

/* USER CODE BEGIN Header_odom_task */
/**
* @brief Function implementing the ODOM_TASK thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_odom_task */
void odom_task(void const * argument)
{
  /* USER CODE BEGIN odom_task */
  /* Infinite loop */
  for(;;)
  {
    odom_update_task();
  }
  /* USER CODE END odom_task */
}
